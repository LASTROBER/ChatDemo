...
public class Client2 {
    ...
    public Client2() throws IOException, ClassNotFoundException {
        ...
        ReadInfoThread2 readInfoThread = new ReadInfoThread2(objectInputStream, name,clientIp,clientPort);
...
class ReadInfoThread2 implements Runnable {
    Scanner scanner = new Scanner(System.in);
    //输入流 用来读操作
    ...
    public ReadInfoThread2(ObjectInputStream oIn, String name,String clientIp,int clientPort) {
