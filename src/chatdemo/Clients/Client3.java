...
public class Client3 {
    ...
    public Client3() throws IOException, ClassNotFoundException {
        ...
        ReadInfoThread3 readInfoThread = new ReadInfoThread3(objectInputStream, name, clientIp, clientPort);
...
class ReadInfoThread3 implements Runnable {
    ...
    public ReadInfoThread3(ObjectInputStream oIn, String name, String clientIp, int clientPort) {
